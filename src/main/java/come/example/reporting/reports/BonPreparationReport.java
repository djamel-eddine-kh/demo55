...
import come.example.dto.BonPreparationDto;
...
public class BonPreparationReport extends AbstractReport {
    ...
    protected  Color product_Card_Backround = Color.decode("#E3F2FD");
    private String fontName = "DejaVuSansMono";
    private int titleFontSize = 16;
    private int columnFontSize = 11;

    public BonPreparationReport(List bonPreparationList, CompanyInfoDto companyInfoDto,List<Parameters> configs ) {
        this.companyInfo = companyInfoDto;
        this.bonPreparationList =  bonPreparationList;
